...
class JetsonHW: public hardware_interface::RobotHW
{
    ...
    JetsonHW(ros::NodeHandle nh)
    {
        ...
        hardware_interface::JointHandle vel_handle_right(jnt_state_interface.getHandle("right_wheel_joint"), &cmd[0]);
        ...
        encoder_left_sub=nh.subscribe<std_msgs::UInt64>("/arduino/encoder_left_speed",10, &JetsonHW::leftEncoderCB, this);
